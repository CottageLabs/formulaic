...
from formulaic.serialise.xml2 import XMLSerialiser, ATTRIBUTE, TEXT, XMLFieldCapability, XMLStructureCapability


class DCXMLFieldCapability(XMLFieldCapability):
...
class DCField(Field):
    capabilities = (DCXMLFieldCapability(),)

# class DCStructRef(StructRef):
#     capabilities = (DCXMLStructRefCapability())


class DCStructure(Structure):
...
serialiser = XMLSerialiser(field_capability_class=DCXMLFieldCapability, structure_capability_class=DCXMLStructureCapability)
